...
class AnnotatedInstanceMethodSpec extends Specification {
    ...
    def "Resolves a method"() {
        ...
        e.message ==~ /^@ExcelModelCreator is not allowed to be annotated on instance method; Remove the annotation from the method\[.+]$/
    }
    ...
    private static class TestModel {
        ...
        @ExcelModelCreator
        TestModel toUpperCase() {
            new TestModel(this.name.toUpperCase(Locale.US))
        }
    }

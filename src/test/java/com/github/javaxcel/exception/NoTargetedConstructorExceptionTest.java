...
class NoTargetedConstructorExceptionTest {
    ...
    void test1() {
        ...
        // when
        NoTargetedConstructorException exception = new NoTargetedConstructorException(message, type);
    ...
    void test2() {
        ...
        // when
        NoTargetedConstructorException exception = new NoTargetedConstructorException(message, cause, type);
    ...
    void test3() {
        ...
        // when
        NoTargetedConstructorException exception = new NoTargetedConstructorException(cause, type);
